<x-admin-layout title="Bewerk {{ $ride->name }} - Dashboard • VentureValley">
    @push('head')
        @vite(['resources/js/admin-publishing.js'])
    @endpush

    <div class="flex justify-between items-center pb-3.5">
        <h1 class="text-5xl text-[--color-primary] max-sm:text-4xl">Bewerk {{ $ride->name }}</h1>
    </div>
    <div class="flex gap-5">
        <section class="w-3/4">
            <form action="{{ route('admin.attracties.update', $ride) }}" method="post" enctype="multipart/form-data"
                ...
                <div class="flex gap-3">
                    <div class="flex flex-col flex-1">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $ride->name) }}" required
                               autocomplete="off"
                               class="input">
                        @error('name')
                    ...
                    <div class="flex flex-col flex-1">
                        ...
                        <input type="text" name="type" id="type" value="{{ old('type', $ride->type) }}" required
                               class="input">
                        @error('type')
                        <span class="text-red-700">{{ $message }}</span>
                        @enderror
                ...
                <div class="flex gap-3">
                    <div class="flex flex-col flex-1">
                        ...
                        <input type="text" name="subtitle" id="subtitle" value="{{ old('subtitle', $ride->subtitle) }}"
                               required
                    ...
                    <div class="flex flex-col flex-1">
                        ...
                        <input type="text" name="tagline" id="tagline" value="{{ old('tagline', $ride->tagline) }}"
                               required
                ...
                <div class="flex flex-col flex-1">
                    ...
                    <textarea rows="3" name="description" id="description" required
                              class="input">{{ old('description', $ride->description) }}</textarea>
                    @error('subtitle')
                    <span class="text-red-700">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-5 gap-3">
                    <div class="flex flex-col">
                        ...
                        <input type="number" name="stat_speed" id="stat_speed"
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="number" name="stat_length" id="stat_length"
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="number" name="stat_height" id="stat_height"
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="number" name="stat_duration" id="stat_duration"
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="number" name="stat_capacity" id="stat_capacity"
                ...
                <div class="grid grid-cols-3 gap-3">
                    <div class="flex flex-row gap-4">
                        ...
                        <input type="checkbox" name="property_controllable" id="property_controllable" value="1"
                               class="input" @checked(old('property_controllable', (string)$ride->property_controllable) === "1")>
                    ...
                    <div class="flex flex-row gap-4">
                        ...
                        <input type="checkbox" name="property_audio" id="property_audio" value="1"
                               class="input" @checked(old('property_audio', (string)$ride->property_audio) === "1")>
                    ...
                    <div class="flex flex-row gap-4">
                        ...
                        <input type="checkbox" name="property_smoothcoasters" id="property_smoothcoasters" value="1"
                               class="input" @checked(old('property_smoothcoasters', (string)$ride->property_smoothcoasters) === "1")>
                ...
                <input type="hidden" name="public" id="public" value="{{ old('public', (string)$ride->public) }}">
            </form>
        </section>
                ...
                <li>
                    <div class="flex flex-row gap-4">
                        ...
                        <input type="checkbox" name="setter-public" id="setter-public"
                               class="input" @checked(old('public', (string)$ride->public) === "1")>
                    </div>
                </li>
            </ul>
