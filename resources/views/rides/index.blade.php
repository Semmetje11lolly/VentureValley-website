    ...
    <section class="flex flex-col gap-8 text-center py-14">
        <div>
            ...
            <p class="text-lg">Beleef ons ruime aanbod aan spectaculaire attracties! Blus een bosbrand, ga op avontuur
                door de ruimte of ervaar hoe het is om een piraat te zijn. Er is van alles te beleven in VentureValley.
                Bekijk hier het overzicht van al onze attracties.</p>
        </div>
        <hr>
            ...
            @foreach($rides as $ride)
                <a href="{{ route('attracties.show', $ride->slug) }}">
                    <article
                        ...
                        style="background-image: linear-gradient(180deg, #00000000 70%, #000000 100%), url({{ asset('storage/' . $ride->list_image) }}); box-shadow: 0 0 10px 0 rgba(0, 0, 0, 0.5); corner-shape: scoop">
